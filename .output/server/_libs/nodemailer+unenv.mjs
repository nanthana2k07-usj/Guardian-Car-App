...
import { a as notImplemented, i as init_utils, o as notImplementedClass } from "./framer-motion.mjs";
...
var require_nodemailer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var nmfetch = require_fetch();
	var packageData = (init_package(), __toCommonJS(package_exports).default);
	var ETHEREAL_API = (processModule.env.ETHEREAL_API || "https://api.nodemailer.com").replace(/\/+$/, "");
	var ETHEREAL_WEB = (processModule.env.ETHEREAL_WEB || "https://ethereal.email").replace(/\/+$/, "");
	var ETHEREAL_API_KEY = (processModule.env.ETHEREAL_API_KEY || "").replace(/\s*/g, "") || null;
	var ETHEREAL_CACHE = [
		"true",
		"yes",
		"y",
		"1"
	].includes((processModule.env.ETHEREAL_CACHE || "yes").toString().trim().toLowerCase());
